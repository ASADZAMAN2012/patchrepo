...
##Test 1: Repost to a group, delete group, add new group
	def test01_pre_open_news_GroupRepostNote
		repostNotePop
		sleep 3
...
##Test 2: Repost to a group, delete group, add new group
	def test02_pre_open_news_GroupRepostArticle
		repostArticlePop
		sleep 3
		groupAddRemoveAdd "Repost text #{random}."
 		sleep 3
...
##Test 3: Repost to two groups
	def test03_pre_open_news_TwoGroupsRepostArticle
		repostArticlePop
		sleep 3
		twoGroupSelect
		sleep 3
...
##Test 4: Repost to two groups
	def test04_pre_open_news_TwoGroupsRepostMedia
		repostMediaPop
		sleep 3
		twoGroupSelect
		sleep 3
...
##Test 5: Repost without note text populated
	def test05_pre_open_news_NoNoteRepostNote
		repostNotePop
		sleep 3
 		repost "" #No note
 		sleep 3
