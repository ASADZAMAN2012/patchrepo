...
#Test 1: Video clip
	def test01_pre_open_news_MediaVideoClip
...
#Test 2: Two video clips
	def test02_pre_open_news_MediaTwoVideoClips
		login $editor_1_email, $master_password
		$browser.goto($patch_news_pre_open)
...
#Test 3: Media Video
	def test03_pre_open_news_MediaVideo
		login $editor_1_email, $master_password
		$browser.goto($patch_news_pre_open)
...
#Test 4: Media 2 Videos
	def test04_pre_open_news_MediaTwoVideo
		login $editor_1_email, $master_password
		$browser.goto($patch_news_pre_open)
...
#Test 5: Article Video, Photo, PDF
	def test05_pre_open_news_ArticleVideoPhotoPDF
		login $editor_1_email, $master_password
