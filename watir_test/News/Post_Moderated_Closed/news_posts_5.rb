...
#Test 1: Delete an article post
	def test01_post_closed_news_delete_article_post_TC_24307
...
#Test 2: Post a note outside home community
	def test02_post_closed_news_post_note_outside_home_TC_27491
		login $editor_1_email, $master_password
...
#Test 3: Post an article outside home community	
	def test03_post_closed_news_post_article_outside_home_TC_27491	
		login $editor_1_email, $master_password
...
#Test 4: Post media outside home community
	def test04_post_closed_news_post_media_outside_home_TC_27491
		login $editor_1_email, $master_password
		$browser.goto($patch_flatiron_news_school_news)
		postNoteSetup("Post media note outside community #{random}")
		sleep 4		
		$post_edit_post.exists?
	end
end