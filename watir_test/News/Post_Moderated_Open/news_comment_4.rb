...
#Test 1: Flag Article Inline Comment
	def test01_post_open_news_FlagArticleComment
...
##Test 2: Close Flag Note Inline Comment
	def test02_post_open_news_CloseFlagNoteDialog
		login $user_1_email, $master_password
...
##Test 3: Close Flag Article Inline Comment
	def test03_post_open_news_CloseFlagArticleDialog
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_article)
		sleep 2
		commentPopSubmit "Test Comment #{random}"
...
##Test 4: Close Flag Media Inline Comment
	def test04_post_open_news_CancelFlagMediaDialog
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_note)
		sleep 2
		commentPopSubmit "Test Comment #{random}"
...
##Test 5: Flag Media Inline Comment
	def test05_post_open_news_FlagMediaComment_TC_24319
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_note)
