...
##Test 1: Two Media Inline Comments
	def test01_post_open_news_MediaTwoComments
...
##Test 4: Delete Note Inline Comment
	def test04_post_open_news_DeleteNoteOneComment_TC_24319
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_note)
...
##Test 5: Delete Article Inline Comment
	def test05_post_open_news_DeleteArticleOneComment_TC_24319
		login $user_1_email, $master_password
