...
#Test 1: Save new article draft then post
	def test01_post_open_news_publish_article_draft_TC_24300
...
#Test 2: Delete Article draft
	def test02_post_open_news_publish_article_draft_TC_24309
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_article_new)
...
#Test 3: Edit Article draft
	def test04_post_open_news_edit_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_article_new)
...
#Test 4: Cancel deleting Article draft
	def test02_post_open_news_cancel_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_article_new)
...
#Test 5: Close delete Article draft dialog
	def test05_post_open_news_close_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_article_new)
