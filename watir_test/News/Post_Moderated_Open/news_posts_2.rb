...
#Test 1: Video clip
	def test01_post_open_news_MediaVideoClip
...
#Test 2: Two video clips
	def test02_post_open_news_MediaTwoVideoClips
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open)
...
#Test 3: Media Video
	def test03_post_open_news_MediaVideo
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open)
...
#Test 4: Media 2 Videos
	def test04_post_open_news_MediaTwoVideo
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open)
...
#Test 5: Article Video, Photo, PDF
	def test05_post_open_news_ArticleVideoPhotoPDF
		login $user_1_email, $master_password
