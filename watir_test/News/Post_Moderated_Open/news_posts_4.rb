...
#Test 1: Edit a note post
	def test01_post_open_news_edit_note_post_TC_24306
...
#TC 24307
	def test04_post_open_news_delete_note_post_TC24307
		login $editor_1_email, $master_password
...
#TC 24307
	def test05_post_open_news_delete_media_post_TC_24307
		login $editor_1_email, $master_password
		$browser.goto($patch_news_post_open)
