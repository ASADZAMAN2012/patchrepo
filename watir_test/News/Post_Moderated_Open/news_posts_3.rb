...
#Test 1: Note Video
	def test01_post_open_news_NoteVideo_TC_24303
...
#Test 2: Note Two Videos
	def test02_post_open_news_NoteTwoVideo_TC_24303
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open)
		sleep 2
...
#Test 3: Note Video, Photo, PDF
	def test03_post_open_news_NoteVideoPhotoPDF_TC_24302_TC_24304
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open)
		sleep 2
...
#Test 4: Article Video
	def test04_post_open_news_ArticleVideo_TC_24303
		login $user_1_email, $master_password
...
#Test 5: Article Two Videos
	def test05_post_open_news_ArticleTwoVideo_TC_24303
		login $user_1_email, $master_password
		$browser.goto($patch_news_post_open_article_new)
