...
#Test 1: Note Video
	def test01_pre_closed_news_NoteVideo_TC_24303
...
#Test 2: Note Two Videos
	def test02_pre_closed_news_NoteTwoVideo_TC_24303
		login $editor_1_email, $master_password
		$browser.goto($patch_news_pre_open)
		sleep 2
...
#Test 4: Article Video
	def test04_pre_closed_news_ArticleVideo_TC_24303
		login $editor_1_email, $master_password
...
#Test 5: Article Two Videos
	def test05_pre_closed_news_ArticleTwoVideo_TC_24303
		login $editor_1_email, $master_password
		$browser.goto($patch_news_pre_open_article_new)
