...
#Test 1: Save new article draft then post
	def est01_pre_closed_news_publish_article_draft_TC_24300  #flakey, doesn't dynamically choose the proper group
...
#Test 2: Delete Article draft
	def test02_pre_closed_news_publish_article_draft_TC_24309
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_article_new)
...
#Test 3: Edit Article draft
	def test03_pre_closed_news_edit_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_article_new)
...
#Test 4: Cancel deleting Article draft
	def test04_pre_closed_news_cancel_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_article_new)
...
#Test 5: Close delete Article draft dialog
	def test05_pre_closed_news_close_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_article_new)
