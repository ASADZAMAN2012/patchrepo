...
##Test 1: Delete Media Inline Comment
	def test01_pre_closed_news_DeleteMediaOneComment_TC_24319
...
##Test 2: Cancel Delete Note Inline Comment
	def test02_pre_closed_news_CancelDeleteNoteOneComment_TC_24319
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_note)
...
##Test 3: Cancel Delete Article Inline Comment
	def test03_pre_closed_news_CancelDeleteArticleOneComment
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_article)
		sleep 2
		commentPopSubmit "Test Comment #{random}"
		sleep 2
		commentCancelDelete
...
##Test 4: Cancel Delete Media Inline Comment
	def test04_pre_closed_news_CancelDeleteMediaOneComment
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_article)
		sleep 2
		commentPopSubmit "Test Comment #{random}"
...
###Test 5: Flag Note Inline Comment
	def test05_pre_closed_news_FlagNoteComment
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_note)
		sleep 2
		commentPopSubmit "Test Comment #{random}"
