...
#Test 1: Edit a note post
	def test01_pre_closed_news_edit_note_pre_TC_24306
...
#Test 2: Edit a media post
	def test02_pre_closed_news_edit_media_pre_TC_24306
		login $editor_1_email, $master_password
		$browser.goto($patch_news_pre_open_note)
...
#Test 3: Edit an article post
	def test03_pre_closed_news_edit_article_pre_TC_24306
		login $editor_1_email, $master_password
...
#TC 24307
	def test04_pre_closed_news_delete_note_pre_TC24307
		login $editor_1_email, $master_password
...
#TC 24307
	def test05_pre_closed_news_delete_media_pre_TC_24307
		login $editor_1_email, $master_password
		$browser.goto($patch_news_pre_open)
