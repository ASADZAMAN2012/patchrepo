...
##Test 1: Cancel Flag Note Inline Comment
	def test01_pre_closed_news_CancelFlagNoteComment_TC_24319
...
##Test 2: Cancel Flag Article Inline Comment
	def test02_pre_closed_news_CancelFlagArticleComment_TC_24319
		login $user_1_email, $master_password
...
##Test 3: Cancel Flag Media Inline Comment
	def test03_pre_closed_news_CancelFlagMediaComment_TC_24319
		login $user_1_email, $master_password
		$browser.goto($patch_news_pre_closed_note)
