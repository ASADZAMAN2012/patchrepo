...
#Test 1: Delete reposted note
	def test01_pre_closed_news_delete_repost_note_TC_24322
...
#Test 2: Delete reposted article
	def test02_pre_closed_news_delete_repost_article_TC_24322
		login $user_1_email, $master_password
		$browser.goto($patch_article_to_edit)
		
		repost "Repost text #{random}" s
		$post_delete_post.when_present.click
		sleep 2
		$post_delete_confirm.click
...
#Test 3: Delete reposted media
	def test03_pre_closed_news_delete_repost_media_TC_24322
		login $user_1_email, $master_password
...
#Test 4: Flag reposted note
	def test04_pre_closed_news_flag_repost_note_TC_24323
		login $user_1_email, $master_password
...
#Test 5: Flag reposted article
	def test05_pre_closed_news_flag_repost_article_TC_24323
		login $user_1_email, $master_password
