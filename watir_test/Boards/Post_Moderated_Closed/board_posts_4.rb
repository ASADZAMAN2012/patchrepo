...
#Test 1: Edit a note post
	def test01_post_closed_board_edit_note_post_TC_24306
...
#Test 2: Edit a media post
	def test02_post_closed_board_edit_media_post_TC_24306
		login $user_1_email, $master_password
...
#Test 3: Edit an article post
	def test03_post_closed_board_edit_article_post_TC_24306
		login $user_1_email, $master_password
...
#TC 24307
	def test04_post_closed_board_delete_note_post_TC24307
...
#TC 24307
	def test05_post_closed_board_delete_media_post_TC_24307
