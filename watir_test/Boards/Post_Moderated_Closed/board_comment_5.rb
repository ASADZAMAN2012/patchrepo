...
##Test 1: Cancel Flag Note Inline Comment
	def test01_post_closed_board_CancelFlagNoteComment_TC_24319
...
##Test 2: Cancel Flag Article Inline Comment
	def test02_post_closed_board_CancelFlagArticleComment_TC_24319
		login $user_1_email, $master_password
...
##Test 3: Cancel Flag Media Inline Comment
	def test03_post_closed_board_CancelFlagMediaComment_TC_24319
		login $user_1_email, $master_password
		$browser.goto($patch_boards_post_closed_note)
