...
#Test 1: Flag Article Inline Comment
	def test01_post_closed_board_FlagArticleComment
...
##Test 2: Close Flag Note Inline Comment
	def test02_post_closed_board_CloseFlagNoteDialog
		login $user_1_email, $master_password
...
##Test 3: Close Flag Article Inline Comment
	def test03_post_closed_board_CloseFlagArticleDialog
		login $user_1_email, $master_password
		$browser.goto($patch_boards_post_closed_article)
		sleep 2
		commentPopSubmit "Test Comment #{random}"
...
##Test 4: Close Flag Media Inline Comment
	def test04_post_closed_board_CancelFlagMediaDialog
		login $user_1_email, $master_password
		$browser.goto($patch_boards_post_closed_note)
		sleep 2
		commentPopSubmit "Test Comment #{random}"
...
##Test 5: Flag Media Inline Comment
	def test05_post_closed_board_FlagMediaComment_TC_24319
		login $user_1_email, $master_password
		$browser.goto($patch_boards_post_closed_note)
