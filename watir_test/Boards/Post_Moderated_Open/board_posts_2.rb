...
#Test 1: Video clip
	def test01_post_open_board_MediaVideoClip
...
#Test 2: Two video clips
	def test02_post_open_board_MediaTwoVideoClips
		login $user_1_email, $master_password
		$browser.goto($patch_media)
...
#Test 3: Media Video
	def test03_post_open_board_MediaVideo
		login $user_1_email, $master_password
		$browser.goto($patch_media)
...
#Test 4: Media 2 Videos
	def test04_post_open_board_MediaTwoVideo
		login $user_1_email, $master_password
		$browser.goto($patch_media)
...
#Test 5: Article Video, Photo, PDF
	def test05_post_open_board_ArticleVideoPhotoPDF
		login $user_1_email, $master_password
