...
#Test 1: Edit a note post
	def test01_pre_open_board_edit_note_post_TC_24306
...
#Test 2: Edit a media post
	def test02_pre_open_board_edit_media_post_TC_24306
		login $user_1_email, $master_password
...
#Test 3: Edit an article post
	def test03_pre_open_board_edit_article_post_TC_24306
		login $user_1_email, $master_password
		...
		$post_now_edit.when_present.fire_event("onclick")
		sleep 2
...
#TC 24307
	def test04_pre_open_board_delete_note_post_TC24307
...
#TC 24307
	def test05_pre_open_board_delete_media_post_TC_24307
