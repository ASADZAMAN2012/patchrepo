...
##Test 1: Repost without note text populated
	def test01_pre_open_board_NoNoteRepostArticle
		repostArticlePop
		sleep 3
		repost "" #No note
		sleep 3
...
##Test 2: Repost without note text populated
	def test01_pre_open_board_NoNoteRepostMedia
		repostMediaPop
		sleep 3
		repost "" #No note
		sleep 3
...
##Test 3: Repost note with exactly 250 characters
	def test03_pre_open_board_250RepostNote
		repostNotePop
		sleep 3
 		repostPopulate250
 		sleep 3
...
##Test 4: Repost note with exactly 250 characters
	def test04_pre_open_board_250RepostArticle
		repostArticlePop
		sleep 3
		repostPopulate250
		sleep 3
...
##Test 5: Repost note with exactly 250 characters
	def test05_pre_open_board_250RepostMedia
		repostMediaPop
		sleep 3
		repostPopulate250
		sleep 3
