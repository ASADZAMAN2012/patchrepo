...
#Test 1: Flag Article Inline Comment
	def test01_pre_open_board_FlagArticleComment
...
##Test 2: Close Flag Note Inline Comment
	def test02_pre_open_board_CloseFlagNoteDialog
...
##Test 3: Close Flag Article Inline Comment
	def test03_pre_open_board_CloseFlagArticleDialog
...
##Test 4: Close Flag Media Inline Comment
	def test04_pre_open_board_CancelFlagMediaDialog
		create_article_1jpeg_wGroup "Article post for close flag comment #{random}"
		sleep 4
		commentPopSubmit "Test Comment #{random}"
		sleep 4
		commentCloseFlag
...
##Test 5: Flag Media Inline Comment
	def test05_pre_open_board_FlagMediaComment_TC_24319
