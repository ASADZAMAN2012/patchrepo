...
#Test 1: New open art group
	def test01_blog_OpenArt_TC_24397
...
#Test 2: New open business group
	def test02_blog_OpenBusiness_TC_24397
		login $user_1_email, $master_password
...
#Test 3: New open education group
	def test03_blog_OpenEducation_TC_24397
		login $user_1_email, $master_password
...
#Test 4: New open family group
	def test04_blog_OpenFamily_TC_24397
		login $user_1_email, $master_password
...
#Test 5: New open living group
	def test05_blog_OpenLiving_TC_24397
		login $user_1_email, $master_password
