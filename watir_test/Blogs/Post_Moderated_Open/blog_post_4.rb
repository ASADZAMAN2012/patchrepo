...
#Test 1: Edit a note post
	def test01_post_open_blog_edit_note_post_TC_24306
...
#Test 2: Edit a media post
	def test02_post_open_blog_edit_media_post_TC_24306
		login $user_1_email, $master_password
		$browser.goto($patch_blogs_post_open_note)
...
#Test 3: Edit an article post
	def test03_post_open_blog_edit_article_post_TC_24306
		login $user_1_email, $master_password
...
#TC 24307
	def test04_post_open_blog_delete_note_post_TC24307
		login $user_1_email, $master_password
...
#TC 24307
	def test05_post_open_blog_delete_media_post_TC_24307
		login $user_1_email, $master_password
		$browser.goto($patch_blogs_post_open)
