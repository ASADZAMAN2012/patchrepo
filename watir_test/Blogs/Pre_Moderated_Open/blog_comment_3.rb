...
##Test 1: Delete Media Inline Comment
	def test01_pre_open_blog_DeleteMediaOneComment_TC_24319
...
##Test 2: Cancel Delete Note Inline Comment
	def test02_pre_open_blog_CancelDeleteNoteOneComment_TC_24319
		login $user_1_email, $master_password
...
##Test 3: Cancel Delete Article Inline Comment
	def test03_pre_open_blog_CancelDeleteArticleOneComment
...
##Test 4: Cancel Delete Media Inline Comment
	def test04_pre_open_blog_CancelDeleteMediaOneComment
		create_article_1jpeg_wGroup "Article post from cancel delete comment #{random}"
		sleep 4
		commentPopSubmit "Test Comment #{random}"
		sleep 4
		commentCancelDelete
...
###Test 5: Flag Note Inline Comment
	def test05_pre_open_blog_FlagNoteComment
