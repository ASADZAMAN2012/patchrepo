...
#Test 1: Delete an article post
	def test01_pre_open_blog_delete_article_post_TC_24307
...
#Test 2: Post a note outside home community
	def test02_pre_open_blog_post_note_outside_home_TC_27491
...
#Test 3: Post an article outside home community	
	def test03_pre_open_blog_post_article_outside_home_TC_27491	
...
#Test 4: Post media outside home community
	def test04_pre_open_blog_post_media_outside_home_TC_27491
		create_article_1jpeg_wGroup "Article media post from comments #{random}"
