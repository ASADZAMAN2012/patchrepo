...
##Test 1: New Article: Cancel
	def test01_pre_open_blog_ArticleCancel
...
##Test 2: New Media: Cancel
	def test02_pre_open_blog_MediaCancel
		login $user_1_email, $master_password
...
##Test 3: New Event: Cancel
	def test03_pre_open_blog_EventCancel
		login $user_1_email, $master_password
		...
		assert $post_pick_group.exists?
 		...
 		$post_event_calendar_start_text.set("#{next_year}-03-06")  
