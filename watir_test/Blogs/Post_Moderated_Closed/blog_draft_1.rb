...
#Test 1: Save new article draft then post
	def test01_post_closed_blog_publish_article_draft_TC_24300
...
#Test 2: Delete Article draft
	def test02_post_closed_blog_publish_article_draft_TC_24309
		login $user_1_email, $master_password
		$browser.goto($patch_blogs_post_closed_article_new)
...
#Test 3: Edit Article draft
	def test04_post_closed_blog_edit_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_blogs_post_closed_article_new)
...
#Test 4: Cancel deleting Article draft
	def test02_post_closed_blog_cancel_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_blogs_post_closed_article_new)
...
#Test 5: Close delete Article draft dialog
	def test05_post_closed_blog_close_article_draft
		login $user_1_email, $master_password
		$browser.goto($patch_blogs_post_closed_article_new)
