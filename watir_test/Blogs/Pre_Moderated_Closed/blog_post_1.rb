...
##advanced options: publish later verified in PostScenarios3.rb
	def test01_pre_closed_blog_NoteAllFields
...
##advanced options: intro, publish later verified in PostScenarios3.rb
	def test02_pre_closed_blog_ArticleAllFields
		login $user_1_email, $master_password
...
##advanced options: publish later verified in PostScenarios3.rb
	def test03_pre_closed_blog_MediaAllFields
		login $user_1_email, $master_password
...
#Test 4: Photo Post 50+ MB
	def test04_pre_closed_blog_MediaPhoto50Plus
		login $user_1_email, $master_password
		$browser.goto($patch_media)
...
#Test 5: Photo, video, and PDF
	def test05_pre_closed_blog_MediaPhotoVideoPDF
		login $user_1_email, $master_password
		$browser.goto($patch_media)
