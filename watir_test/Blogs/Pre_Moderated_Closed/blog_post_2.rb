...
#Test 1: Video clip
	def test01_pre_closed_blog_MediaVideoClip
...
#Test 2: Two video clips
	def test02_pre_closed_blog_MediaTwoVideoClips
		login $user_1_email, $master_password
		$browser.goto($patch_media)
...
#Test 3: Media Video
	def test03_pre_closed_blog_MediaVideo
		login $user_1_email, $master_password
		$browser.goto($patch_media)
...
#Test 4: Media 2 Videos
	def test04_pre_closed_blog_MediaTwoVideo
		login $user_1_email, $master_password
		$browser.goto($patch_media)
...
#Test 5: Article Video, Photo, PDF
	def test05_pre_closed_blog_ArticleVideoPhotoPDF
		login $user_1_email, $master_password
