...
##Test 1: Two Media Inline Comments
	def test01_pre_closed_blog_MediaTwoComments
		create_article_1jpeg_wGroup "Article for comments #{random}"
		commentPopSubmit "Blog Article Media Comment #{random}"
		commentPopSubmit "Blog Article Media Comment #{random}"
	end
...
##Test 4: Delete Note Inline Comment
	def test04_pre_closed_blog_DeleteNoteOneComment_TC_24319
...
##Test 5: Delete Article Inline Comment
	def test05_pre_closed_blog_DeleteArticleOneComment_TC_24319
		login $user_1_email, $master_password
