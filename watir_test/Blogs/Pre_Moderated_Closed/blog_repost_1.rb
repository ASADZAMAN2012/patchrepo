...
##Test 1: Repost a note
	def test01_pre_closed_blog_repostNote_TC_24313_243414
...
##Test 2: Repost an article
	def test02_pre_closed_blog_repostArticle_TC_24313_243414
		login $user_1_email, $master_password
...
##Test 3: Repost media
	def test03_pre_closed_blog_repostMedia_TC_24313_243414
		login $user_1_email, $master_password
...
##Test 4: Repost to a group, delete group, add new group
	def test04_pre_closed_blog_GroupRepostMedia
		repostMediaPop
		sleep 3
...
##Test 5: Repost to two groups
	def test05_pre_closed_blog_TwoGroupsRepostNote
		repostNotePop
		sleep 3
 		twoGroupSelect
 		sleep 3
